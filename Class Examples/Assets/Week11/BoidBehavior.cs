...
public class BoidBehavior : MonoBehaviour
{
    ...
    [NonSerialized]public BoidController controller;
    ...
    private void Update()
    {
        ...
        {
            var ip = Mathf.Exp(-controller.rotationCoeff * Time.deltaTime * 0.8f);
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireSphere(pos, controller.neighborDist);
    }
}
